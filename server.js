...
app.get('/player_info/select_player', function(req, res)
{
  ...
  var query2 = 'SELECT * FROM football_players WHERE(SELECT id FROM football_players) = ANY(players);';
  var query3 = 'SELECT COUNT(*) FROM football_games WHERE(SELECT id FROM football_players) = ANY(players);';
...
//POST player_info/select_player
app.post('/team_stats', function(req, res)
{
  var query1 = 'SELECT * FROM football_games;';
  var query2 = 'SELECT COUNT(*) FROM football_games WHERE home_score > visitor_score;';
